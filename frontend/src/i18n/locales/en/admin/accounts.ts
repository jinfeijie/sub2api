export default {
    accounts: {
      ...
      usageWindowsHint: '"5h / 7d" are upstream rolling usage windows (e.g. OpenAI ChatGPT, Claude). Grok subscriptions use a weekly limit (rolling ~7 days) and monthly credits (calendar billing period that resets on the billing start/end dates — not a rolling 30-day window). They are set by the provider on the account itself — not by sub2api, and unrelated to mapped models. Usage resets when each window/billing period ends and cannot be lifted from within sub2api.',
      ...
      usageWindow: {
        ...
        grokRequests: 'Req',
        grokTokens: 'Tok',
        grokUnknown: 'Grok quota is unknown until you query billing, or an upstream response includes xAI rate-limit headers.',
        grokRetryAfter: 'Retry after {time}',
        grokProbeTooltip: 'Fetch xAI CLI billing quota (weekly limit / monthly credits)',
        grokProbeErrorReauth: 'Auth expired — re-authorize',
        grokProbeErrorEmpty: 'No quota data',
        grokProbeErrorRateLimit: 'Rate limited — retry later',
        grokProbeErrorNetwork: 'Network error — retry later',
        grokProbeErrorUpstream: 'Upstream query failed',
        grokProbeErrorGeneric: 'Query failed',
        grokProbePersistWarning: 'Quota loaded but was not saved',
        ...
        grokNoHeaders: 'No quota data observed',
        grokApiUsage: 'Api',
        grokMonthlyCreditsLabel: 'Month',
        grokMonthlyBarLabel: '1m',
